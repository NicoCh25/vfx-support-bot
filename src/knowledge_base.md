...
https://vfxsignals.com/registro → registro y medios de pago oficiales.

## 4. Planes y precios — Membresía VIP
- **Mensual:** Gs. 400.000 / $60 USD
- **Trimestral:** Gs. 1.000.000 / $150 USD
...
| Activo | Horario (AR) | Días | TP | SL |
|---|---|---|---|---|
| GOLD (XAUUSD) | 22:50 | Dom–Jue | +100 pips | -200 pips |
...
2. Completar datos: Email, Contraseña, Código de país y teléfono.
3. Aceptar los términos y condiciones del servicio.
4. Hacer clic en "REGÍSTRATE".
5. Listo, cuenta creada en Libertex.

### 9.2 Verificación de cuenta (Parte B)
1. Ingresar a la cuenta en Libertex.
2. En el menú principal, seleccionar "Verificación".
3. Seguir los pasos que indica la plataforma para completar la verificación.
4. Una vez verificada, se puede operar sin restricciones.
...
- Preguntas que no están en esta base de conocimiento.
- Respuesta del bot: "En breve te responde un asesor" + se marca el chat como urgente en una lista para revisión manual de Nicolás.

## 15. Tono y estilo
Español neutro / paraguayo (no rioplatense), ya que el 95% de la audiencia es de Paraguay.

## 16. Regla de pausa de 24hs
Si Nicolás responde manualmente un chat, el bot deja de responder en ese chat por 24hs. Pasado ese tiempo, retoma el control automático.

## 17. Mensajes rápidos de referencia (banco de respuestas ya probadas)
Estos son los mensajes que Nicolás ya usa manualmente — el bot debe inspirarse en su estructura y tono, no necesariamente copiarlos palabra por palabra:

- **Presentación canal gratis:** "Canal de Telegram GRATIS 👉 https://t.me/vfxsignalfree — Operamos todos los días: US30, BTCUSD, XAUUSD"
- **Web oficial:** "Esta es nuestra web oficial de VFX Signals. Ahí vas a encontrar toda la información sobre el canal VIP, registros, acceso y medios de pago oficiales ✅ 👉 https://vfxsignals.com"
